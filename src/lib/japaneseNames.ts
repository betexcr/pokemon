...
const pokemonIdToJapanese: Record<number, string> = {
  ...
  851: 'ヤクデ',    // Sizzlipede
  852: 'マルヤクデ',    // Centiskorch
  853: 'タタッコ',    // Clobbopus
  854: 'オトスパス',    // Grapploct
  855: 'ヤバチャ',    // Sinistea
  856: 'ポットデス',    // Polteageist
  857: 'ミブリム',    // Hatenna
  858: 'テブリム',    // Hattrem
  859: 'ブリムオン',    // Hatterene
  860: 'ベロバー',    // Impidimp
  861: 'ギモー',    // Morgrem
  862: 'オーロンゲ',    // Grimmsnarl
  863: 'タチフサグマ',    // Obstagoon
  864: 'ニャイキング',    // Perrserker
  865: 'サニゴーン',    // Cursola
  866: 'ネギガナイト',    // Sirfetch’d
  867: 'バリコオル',    // Mr. Rime
  868: 'デスバーン',    // Runerigus
  869: 'マホミル',    // Milcery
  870: 'マホイップ',    // Alcremie
  871: 'タイレーツ',    // Falinks
  872: 'バチンウニ',    // Pincurchin
  873: 'ユキハミ',    // Snom
  874: 'モスノウ',    // Frosmoth
  875: 'イシヘンジン',    // Stonjourner
  876: 'コオリッポ',    // Eiscue
  877: 'イエッサン',    // Indeedee
  878: 'モルペコ',    // Morpeko
  879: 'ゾウドウ',    // Cufant
  880: 'ダイオウドウ',    // Copperajah
  881: 'パッチラゴン',    // Dracozolt
  882: 'パッチルドン',    // Arctozolt
  883: 'パッチラドン',    // Dracovish
  884: 'パッチルゴン',    // Arctovish
  885: 'ジュラルドン',    // Duraludon
  886: 'ドラメシヤ',    // Dreepy
  887: 'ドロンチ',    // Drakloak
  888: 'ドラパルト',    // Dragapult
  889: 'ザシアン',    // Zacian
  890: 'ザマゼンタ',    // Zamazenta
  891: 'ムゲンダイナ',    // Eternatus
  892: 'ダクマ',    // Kubfu
  893: 'ウーラオス',    // Urshifu
  894: 'ザルード',    // Zarude
  895: 'レジエレキ',    // Regieleki
  ...
  1020: 'カグヤドン',    // Gouging Fire
  1021: 'テツノカミ',    // Raging Bolt
  1022: 'テツノイワ',    // Iron Boulder
  1023: 'テツノカンムリ',    // Iron Crown
