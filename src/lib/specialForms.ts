...
export const SPECIAL_FORM_MAPPINGS: Record<number, SpecialFormInfo> = {
  ...
  10052: { id: 10052, name: 'Mega Mawile', japaneseName: 'メガクチート', basePokemonId: 303, basePokemonName: 'Mawile', formType: 'mega', description: 'Twin jaws; deceiver jaws multiply.' },
  ...
  // 10061 is floette-eternal in PokeAPI, not a mega/primal form
  10062: { id: 10062, name: 'Mega Latias', japaneseName: 'メガラティアス', basePokemonId: 380, basePokemonName: 'Latias', formType: 'mega', description: 'Streamlined jet dragon; psychic duo sister.' },
  10063: { id: 10063, name: 'Mega Latios', japaneseName: 'メガラティオス', basePokemonId: 381, basePokemonName: 'Latios', formType: 'mega', description: 'Streamlined jet dragon; psychic duo brother.' },
  10064: { id: 10064, name: 'Mega Swampert', japaneseName: 'メガラグラージ', basePokemonId: 260, basePokemonName: 'Swampert', formType: 'mega', description: 'Muscular swamp brute; torrential power.' },
  10065: { id: 10065, name: 'Mega Sceptile', japaneseName: 'メガジュカイン', basePokemonId: 254, basePokemonName: 'Sceptile', formType: 'mega', description: 'Tail launches like a missile; lightning theme.' },
  10066: { id: 10066, name: 'Mega Sableye', japaneseName: 'メガヤミラミ', basePokemonId: 302, basePokemonName: 'Sableye', formType: 'mega', description: 'Hides behind giant ruby; mischief shielded.' },
  10067: { id: 10067, name: 'Mega Altaria', japaneseName: 'メガチルタリス', basePokemonId: 334, basePokemonName: 'Altaria', formType: 'mega', description: 'Cotton cloud dress; fairy aria.' },
  10068: { id: 10068, name: 'Mega Gallade', japaneseName: 'メガエルレイド', basePokemonId: 475, basePokemonName: 'Gallade', formType: 'mega', description: 'Cape-like arms; duelist knight.' },
  10069: { id: 10069, name: 'Mega Audino', japaneseName: 'メガタブンネ', basePokemonId: 531, basePokemonName: 'Audino', formType: 'mega', description: 'Healer robes; soothing aura.' },
  10070: { id: 10070, name: 'Mega Sharpedo', japaneseName: 'メガサメハダー', basePokemonId: 319, basePokemonName: 'Sharpedo', formType: 'mega', description: 'Body studded with scars; torpedo shark escalation.' },
  10071: { id: 10071, name: 'Mega Slowbro', japaneseName: 'メガヤドラン', basePokemonId: 80, basePokemonName: 'Slowbro', formType: 'mega', description: 'Shellder shell engulfs body like armor.' },
  10072: { id: 10072, name: 'Mega Steelix', japaneseName: 'メガハガネール', basePokemonId: 208, basePokemonName: 'Steelix', formType: 'mega', description: 'Diamonds stud body; subterranean titan.' },
  10073: { id: 10073, name: 'Mega Pidgeot', japaneseName: 'メガピジョット', basePokemonId: 18, basePokemonName: 'Pidgeot', formType: 'mega', description: 'Grand plumage; storm tailwinds.' },
  10074: { id: 10074, name: 'Mega Glalie', japaneseName: 'メガオニゴーリ', basePokemonId: 362, basePokemonName: 'Glalie', formType: 'mega', description: 'Jaw splits open; chilling maw.' },
  10075: { id: 10075, name: 'Mega Diancie', japaneseName: 'メガディアンシー', basePokemonId: 719, basePokemonName: 'Diancie', formType: 'mega', description: 'Gem gown; dazzling prism queen.' },
  10076: { id: 10076, name: 'Mega Metagross', japaneseName: 'メガメタグロス', basePokemonId: 376, basePokemonName: 'Metagross', formType: 'mega', description: 'Four-unit fusion; supercomputer brain.' },
  ...
  // 10080-10085 are Pikachu costume forms in PokeAPI, not mega forms
  // 10086 is hoopa-unbound
  10087: { id: 10087, name: 'Mega Camerupt', japaneseName: 'メガバクーダ', basePokemonId: 323, basePokemonName: 'Camerupt', formType: 'mega', description: 'Single massive volcano hump; lava reservoir.' },
  10088: { id: 10088, name: 'Mega Lopunny', japaneseName: 'メガミミロップ', basePokemonId: 428, basePokemonName: 'Lopunny', formType: 'mega', description: 'Kicking specialist; fighter garb.' },
  10089: { id: 10089, name: 'Mega Salamence', japaneseName: 'メガボーマンダ', basePokemonId: 373, basePokemonName: 'Salamence', formType: 'mega', description: 'Wing forms a crescent blade; supersonic glider.' },
  10090: { id: 10090, name: 'Mega Beedrill', japaneseName: 'メガスピアー', basePokemonId: 15, basePokemonName: 'Beedrill', formType: 'mega', description: 'Lance-like stingers on arms and tail; raid hornet.' },
}

const SPECIAL_FORM_ID_SET = new Set(Object.keys(SPECIAL_FORM_MAPPINGS).map(Number))

export function isSpecialForm(id: number): boolean {
  return SPECIAL_FORM_ID_SET.has(id)
}
