  ...
  return (
    <div ref={containerRef} className="relative w-full h-full">
      ...
      {hoveredStatIndex !== null && (
        <div
          className="absolute z-10 text-gray-800 dark:text-gray-200 px-3 py-2 rounded-lg text-sm shadow-lg pointer-events-none border border-gray-200 dark:border-gray-700"
          style={{
            left: cursorPos.x + 12,
            top: cursorPos.y + 12,
            background: `linear-gradient(180deg, ${getStatBaseColor(stats[hoveredStatIndex])}15 0%, transparent 60%), var(--tooltip-bg, rgba(255, 255, 255, 0.7))`
          }}
        >
      ...
      {hoveredPokemon && hoveredStatIndex === null && (
        <div
          ...
          style={{
            left: cursorPos.x + 12,
            top: cursorPos.y + 12,
            background: `linear-gradient(180deg, ${colors[pokemons.findIndex(p => p.id === hoveredPokemon.id) % colors.length]}15 0%, transparent 60%), var(--tooltip-bg, rgba(255, 255, 255, 0.9))`
          }}
        >
