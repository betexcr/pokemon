    ...
    <div className={`space-y-3 ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={disabled}
          className="w-full pl-10 pr-10 py-2 border border-border rounded-lg focus:ring-2 focus:ring-poke-blue focus:border-transparent bg-surface text-text transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        />
        {search && (
          <button
            onClick={clearSearch}
