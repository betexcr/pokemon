  ...
  fetchMove: jest.fn((idOrName) => {
    const mockMoves = {
      ...
      'leer': {
        ...
        priority: 0,
        meta: { crit_rate: 0, makes_contact: false },
        effect_entries: [{ language: { name: 'en' }, short_effect: 'Lowers the target\'s Defense by one stage.' }],
      ...
      'smokescreen': {
        ...
        priority: 0,
        meta: { crit_rate: 0, makes_contact: false },
        effect_entries: [{ language: { name: 'en' }, short_effect: 'Lowers the target\'s accuracy by one stage.' }],
      ...
      'charm': {
        ...
        priority: 0,
        meta: { crit_rate: 0, makes_contact: false },
        effect_entries: [{ language: { name: 'en' }, short_effect: 'Lowers the target\'s Attack by two stages.' }],
      ...
      'swords-dance': {
        ...
        priority: 0,
        meta: { crit_rate: 0, makes_contact: false },
        effect_entries: [{ language: { name: 'en' }, short_effect: 'Raises the user\'s Attack by two stages.' }],
        stat_changes: [{ stat: { name: 'attack' }, change: 2 }],
        effect_chance: 100
      },
      'calm-mind': {
        ...
        priority: 0,
        meta: { crit_rate: 0, makes_contact: false },
        effect_entries: [{ language: { name: 'en' }, short_effect: 'Raises the user\'s Special Attack and Special Defense by one stage each.' }],
